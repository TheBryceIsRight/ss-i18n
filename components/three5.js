    ...
    return (<React.Fragment>
        ...
        <svg width="100%" height="600">  
            ...
            <g className="main">
                ...
                <g className="card">
                <rect fill="none" stroke="#ccc" opacity="0.75" strokeWidth="3" width="341" height="541" rx="31" ry="31" />
                <rect fill="url(#cardBg)" width="340" height="540" rx="30" ry="30" opacity="0.8" />
                <text className="numTxt" fill="#f0f0f0" fontSize="23">4678 9743 6489 9721</text>
                <text className="nameTxt" fill="#e4e4f4" fontSize="15">BRYCE T WATSON</text>      
                <g className="chip">
