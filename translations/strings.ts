...
const strings: Strings = {
  ...
  es: {
    ...
    more_business_info: "Más información comercial",
    lets_talk_about_you: "Hablemos de usted",
    business_contact: "Información de contacto comercial",
    legal_information: "Información legal",
    account_setup: "Configuracion de cuenta",
    ...
    placeholder_address: "1234 Peachtree St NW",
    apt_unit: "Departamento",
    zip: "Código postal",
    city: "Ciudad",
    state: "Estado",
    dob: "Fecha de nacimiento",
    change_date: "cambiar fecha",
    id_type: "¿Qué tipo de identificación usas?",
    ...
    primary_email: "Dirección de correo principal",
    placeholder_email: "customer@elavon.com",
    personal_same_as_business: "¿Su dirección personal y comercial es la misma?",
    business_name: "Nombre del Negocio",
    placeholder_business: "Elavon, Inc.",
    primary_business_phone: "Número de teléfono de la empresa principal",
    primary_business_email: "Dirección de correo electrónico comercial",
    business_same_as_legal: "¿Su empresa y dirección legal son las mismas?",
